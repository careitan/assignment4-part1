	...
	if (session_status() == PHP_SESSION_ACTIVE) {
		if (!isset($_POST['username']) && !isset($_SESSION['logged'])){
			...
			if ($_SESSION['logged'] = 1) {
				echo '<h2>Hello '.$_SESSION['username'].', you have visited this page '.$_SESSION['visits1'].' times before.<br>';
				echo 'Click <a href="content2.php">here</a> to visit Content2.PHP page.<br>';
